...
//    render: function(profile) {
		...
		//hhh=this.$el;
		//setTimeout("$('.executive-team').height(hhh.height())",200);


		var execBlock = $('.profile-content').height();
		//alert($execBlock);
		$('.executive-team').height(execBlock + 150);
...
var executive_profiles = TMG["company"].json;

var profile_template = '<div class="executive-avatar">';
profile_template += '<img src="<%= avatar %>">';
